    ...
    <Card className="group relative bg-card border-primary/20 hover:border-primary/50 transition-all duration-300 ease-in-out transform hover:-translate-y-2 shadow-lg hover:shadow-primary/20 overflow-hidden">
      ...
      <CardContent className="text-center p-6 pt-0 relative z-10">
        ...
        <div className="mt-4 flex justify-center space-x-3">
          <a href={socials.linkedin} target="_blank" rel="noopener noreferrer" className="cursor-target">
            <Button variant="secondary" size="icon" className="rounded-full">
              <Linkedin className="h-5 w-5" />
            </Button>
          </a>
          <a href={socials.twitter} target="_blank" rel="noopener noreferrer" className="cursor-target">
            <Button variant="secondary" size="icon" className="rounded-full">
              <Twitter className="h-5 w-5" />
            </Button>
          </a>
          <a href={socials.dribbble} target="_blank" rel="noopener noreferrer" className="cursor-target">
            <Button variant="secondary" size="icon" className="rounded-full">
